...
[배포처 바로가기](https://blog.naver.com/PostThumbnailView.nhn?isHttpsRedirect=true&blogId=hp0&logNo=221170423317&categoryNo=32&parentCategoryNo=0)

&nbsp;

## 웹 폰트

사용하는 `font-family`의 이름은 `HSGyoulnoonkot`입니다.
...
@font-face {
    ...
    src: url('https://cdn.jsdelivr.net/gh/fonts-archive/HSGyoulnoonkot/HSGyoulnoonkot.woff2') format('woff2'),
         ...
         url('https://cdn.jsdelivr.net/gh/fonts-archive/HSGyoulnoonkot/HSGyoulnoonkot.otf') format('opentype'),
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/HSGyoulnoonkot/subsets/HSGyoulnoonkot-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/HSGyoulnoonkot/subsets/HSGyoulnoonkot-dynamic-subset.css');
```
...
```css
font-family: "HSGyoulnoonkot", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
